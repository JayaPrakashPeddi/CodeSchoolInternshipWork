...
function iterateingProducts(data) {
  ...
  cardInstock.classList.add("fs-6", "text-white","border-bottom","text-center");
  ...
  btnDiv.classList.add("d-flex","justify-content-between","align-items-center","mt-2");
...
function getItems(data) {
  parentCartDiv.innerHTML='<h3 class="text-white mt-4 mt-md-0">No items...</h3>';
